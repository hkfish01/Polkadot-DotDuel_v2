        ...
        <div className="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-xl p-6 border border-orange-200 dark:border-orange-800">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div>
              ...
              <span className="font-medium text-gray-900 dark:text-white">2% of prize pool</span>
            </div>
            <div>
              <span className="text-gray-500">Bet Closes:</span>{' '}
              <span className="font-medium text-gray-900 dark:text-white">{bettingHours}h from now</span>
            </div>
            <div>
              <span className="text-gray-500">Min Bet:</span>{' '}
              <span className="font-medium text-gray-900 dark:text-white">0.001 PAS</span>
            </div>
          </div>
        </div>
